...
/**
 * Classe equivalente à tabela <code>GABARITO_OFICIAL</code> no banco de dados. Esta Classe possui os gabaritos 
 * com as respostas corretas das questões enviadas pelo Centro Paula Souza. 
 */
public class GabaritoOficial {
	...
	/**
	 * Cria uma nova instância de <code>GabaritoOficial</code>, com os valores iniciais
	 * atribuídos aos atributos da instância. 
	 * 
	 * @param codigoGabarito - um valor do tipo <code>int</code>, que corresponde ao código do gabarito.
